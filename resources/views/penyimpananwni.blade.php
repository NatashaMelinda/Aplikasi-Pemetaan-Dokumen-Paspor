					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
								<h4 class="card-title">Penyimpanan Dokumen WNI</h4>
								<div class="">
											...
											<table id="basic-datatables" class="display table table-striped table-hover" >
												...
												<tbody>
													<tr>
														...
														<td>
															<form col-md-12>
																<button type="button" class="btn-on btn-success btn-sm" id="alert_demo_4"> Pinjam</button>
...
//== Class definition
	var SweetAlert2Demo = function() {
														//== Demos
															...
															swal({
															title: 'Masukan Identitas Peminjam',
														...
														function() {
														swal("Dokumen Berhasil Diambil!", "Dengan Identitas Peminjam : " + $('#input-field').val() , "success");
														}
															);
															});
